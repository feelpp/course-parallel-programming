...
void matrix_product( Kokkos::View<double**> A, Kokkos::View<double**> C, int n )
{
    Kokkos::parallel_for(
...
void matrix_product( Kokkos::View<double**> A, Kokkos::View<double**> B, Kokkos::View<double**> C, int n )
{
    Kokkos::parallel_for(
        "MatrixProduct", n, KOKKOS_LAMBDA( const int i ) {
            for ( int j = 0; j < n; ++j )
