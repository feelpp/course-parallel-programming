...
__global__ void copy_looper(const T * a, T * c, int ARRAY_SIZE)
{
...
template <typename T>
__global__ void mul_looper(T * b, const T * c, int ARRAY_SIZE)
{
...
template <typename T>
__global__ void add_looper(const T * a, const T * b, const T * d, const T * e, T * c, int ARRAY_SIZE)
{
    int offset = hipBlockIdx_x * hipBlockDim_x + hipThreadIdx_x;
    int stride = hipBlockDim_x * hipGridDim_x;
...
template <typename T>
__global__ void triad_looper(T * a, const T * b, const T * c, int ARRAY_SIZE)
{
    int offset = hipBlockIdx_x * hipBlockDim_x + hipThreadIdx_x;
    int stride = hipBlockDim_x * hipGridDim_x;
    const T scalar = 3.0;
